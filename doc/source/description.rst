...
The plugin uses NetApp unified and/or SolidFire drivers. The NetApp unified driver is a
...
Limitations
-----------
* Up to three NetApp backends can be configured to work with Cinder
